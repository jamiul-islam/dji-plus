      ...
      <div className="flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 border-b  py-4">
          ...
          <div className="flex items-center space-x-3">
            <ImAirplane className="text-gray-900 text-xl" />
          ...
          {/* group  */}
          <div className="flex items-center space-x-3">
            <AiOutlineCamera className="text-gray-900 text-2xl" />
            <div className="flex flex-col">
              <p className="text-sm font-primary text-gray-700">group photo</p>
